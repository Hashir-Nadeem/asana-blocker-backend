...
const rewardSchema = new mongoose.Schema(
  {
    ...
    reward_time: { type: Number, default: 3600 },
    total_reward_time: { type: Number, default: 0 },
    total_utilized_time: { type: Number, default: 0 },
  },
  {
    timestamps: true,
  }
...
export const Rewards =
  ...
  export const ExceptionSite =
    mongoose.models.exceptionSites || mongoose.model("exceptionSites", exceptionSchema);